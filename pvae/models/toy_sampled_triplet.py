...
from .architectures import EncLinear, DecLinear, EncWrapped, DecWrapped, EncMob, DecMob, DecGeo, DecBernouilliWrapper, EncWrappedConv, DecWrappedConv, EncLinearConv, DecLinearConv
...
class ToySampledTriplet(VAE):
    def __init__(self, params):
        ...
        super(ToySampledTriplet, self).__init__(
